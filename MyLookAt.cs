...
namespace XRC.Assignments.Geometry
{
    ...
    public static class MyLookAt
    {
        ...
        public static Vector3 CalculateCentralLookingDirection(Vector3 e, Vector3 p)
        {
            ...
            // <solution>
            // Your code here
            Vector3 c = (p - e).normalized; // Normalise vector to only indicate direction
            // </solution>
        ...
        { 
            ...
            // Your code here
            Vector3 z = c;
            Vector3 x = Vector3.Cross(u, z).normalized; // New right direction
            Vector3 y = Vector3.Cross(z, x).normalized; // New up direction
            return (x, y, z);
            // </solution>
        ...
        public static Matrix4x4 CalculateMatrix(Vector3 x, Vector3 y, Vector3 z)
        {
            ...
            // Set rotation matrix with cube's new vectors
